...
static const double bloating = 1.0;
/// [m] --- The width of the vehicle
static const double width = 2.0 + 2 * bloating;
/// [m] --- The length of the vehicle
static const double length = 3.9 + 2 * bloating;
...
static const float penaltyTurning = 0.1;
/// [#] --- A movement cost penalty for reversing (choosing motion primitives > 2)
static const float penaltyReversing = 0.2;
...
static const float dubinsStepSize = 7.5;
...
static const int dubinsWidth = 400;
