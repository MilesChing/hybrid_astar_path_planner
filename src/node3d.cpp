...
// R = 5
const float Node3D::dy[] = { 0 / Constants::cellSize, -0.4432803099920093 / Constants::cellSize, 0.4432803099920093 / Constants::cellSize};
const float Node3D::dx[] = { 1.5 / Constants::cellSize, 1.433004733688409 / Constants::cellSize, 1.433004733688409 / Constants::cellSize};
const float Node3D::dt[] = { 0, 0.3, -0.3};
